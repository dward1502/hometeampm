// components/TenantTurnerWidget.js
"use client";
import { useEffect } from "react";
import Script from 'next/script';
const TenantTurnerWidget = () => {
// 	useEffect(() => {
// 		try {
...
// };
  ...
  return (
      ...
      />
      <Script
        id="tenant-turner-widget-loader"
        strategy="lazyLoad"
        dangerouslySetInnerHTML={{
          __html: `
          try {
            (function () {
              ...
              if (typeof tt !== "function") {
                ...
                function l() {
                  ...
                  s.type = "text/javascript";
                  s.async = true;
                  s.src = (window.tenantTurnerListingsWidget.environment.root_path ? window.tenantTurnerListingsWidget.environment.root_path + "/widget/widget.js" : "https://app.tenantturner.com/widget/widget.js");
                  var x = d.getElementById("tenant-turner-widget");
                  x.parentNode.insertBefore(s, x);
                }
                if (w.attachEvent) {
                  w.attachEvent("onload", l);
      ...
      />
			<div id='tenant-turner-widget'></div>
		</>
    
  );
};

export default TenantTurnerWidget;
